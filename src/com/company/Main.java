...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n" +
                "The arithmetic mean of the number of positives in the array: " + average);

        boolean isSorted = false;
        while (!isSorted) {
            isSorted = true;
            for (int i = 1; i < num.length; i++) {
                //{3.9, 25.65, -98.23, 52.12, -31.45, -325.232, 21.79, -986.21, -64.23, 51.11, -87.21, 66.12, -12.1, 44.9, -2.9}
                if (num[i] < num[i-1]) {
                    double temp = num[i];
                    num[i] = num[i-1];
                    num[i-1] = temp;
